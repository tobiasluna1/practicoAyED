...
int main() {
    ...
    // Las direcciones de memoria son diferentes para cada variable.
    // La dirección de 'a' es menor que la de 'f', y la de 'f' es menor que la de 'c'.
    // Esto puede deberse al orden de declaración y al tamaño de cada tipo de dato.
    ...
    cout << "temperaturaActual = " << temperaturaActual << "\n";
    cout << "*ptrTemp = " << *ptrTemp << "\n";
    ...
    *ptrTemp = nuevaTemp;
    ...
    int x = 5, y = 9;
    cout << "Antes de swap: x=" << x << ", y=" << y << "\n";
    swap_por_puntero(&x, &y);
    cout << "Después de swap: x=" << x << ", y=" << y << "\n";
    
    // 2) Implementar swap_si_mayor y probar casos (p.ej., 10 y 3, luego 2 y 7).
    int m = 10, n = 3;
    cout << "Antes de swap_si_mayor: m=" << m << ", n=" << n << "\n";
    swap_si_mayor(&m, &n);
    ...
    cout << "Suma: " << suma(v, 5) << "\n";
    cout << "Promedio: " << promedio(v, 5) << "\n";
    cout << "Máximo: " << maximo(v, 5) << "\n";
